/*********************************************
*                                            *
*           Shader is property of            *
*     A Square Games and Simulation, LLC     *
*                  2021                      *
*                                            *
**********************************************/

Shader "ASGS/MetallicRoughnessBlend"
{
	Properties{
		_Color("Color", Color) = (1,1,1,1)
		_MainTex("Albedo (RGB)", 2D) = "white" {}
		_Alpha("Alpha Override", Range(0,1)) = 0
		...
		[Enum(UnityEngine.Rendering.CullMode)] _Cull("Cull", Float) = 2 // 0 - Off // 1 - Front Culling // 2 - Back Culling
	}
